...
def show_criterias():
    ...
    #### Controverses ESG
    Nous ne sélectionnons pas les entreprises confrontées à des **controverses ESG majeures**. Pour chaque pilier (Environnement, Social, Gouvernance), nous exigeons une **note de controverse inférieure ou égale à Y** (niveau modéré).
